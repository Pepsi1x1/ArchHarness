...
export const elements = {
  ...
  promptAttachments: document.getElementById("prompt-attachments"),
  promptAttachmentInput: document.getElementById("prompt-attachment-input"),
  promptAttachmentButton: document.getElementById("prompt-attachment-button"),
  ...
  planningFollowUp: document.getElementById("planning-followup-button"),
